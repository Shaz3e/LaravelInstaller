...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('/') }}logos/fx-favicon.png" type="image/x-icon" />
    <link rel="icon" type="image/png" href="{{ asset('/') }}logos/fx-favicon.png" sizes="16x16" />
    <link rel="icon" type="image/png" href="{{ asset('/') }}logos/fx-favicon.png"
        sizes="32x32" />
    <link rel="icon" type="image/png" href="{{ asset('/') }}logos/fx-favicon.png"
        sizes="96x96" />
    <link href="{{ asset('installer/css/style.min.css') }}" rel="stylesheet" />
    {{-- Customiz CSS --}}
    <link href="{{ asset('installer/css/customize.css') }}" rel="stylesheet" />
    @yield('style')
    <script>
...
<body>
    <div class="master">
        <div class="box">
            <div class="header">
                <img src="{{ asset('installer/logos/installer-logo.png') }}" />
            </div>
            <ul class="step">
